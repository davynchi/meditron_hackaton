...
- Интерпретация результатов с учетом результатов анализов пациентов через LLM-модель.
- Возможность выбирать, какие показатели будут изображенв на графике.
...
- **Фильтры:** уже реализован фильтр по пациенту, легко расширить до дат и типов анализов.
